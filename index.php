...
<html lang="en">
	...
	<body>
       ...
       <!-- Mobile Menu Start Here -->
				...
				<div class="mobile-menu-area">
					<div class="mobile-menu-area-inner">
						<ul>
                            ...
                            <li><a href="menu-card-2.html">Food Menu</a>
                            </li>
        ...
        <section class="banner-area bg_size" style="background-image: url(assets/img/bg.jpg);">
            <div class="overlay"></div>
            <div class="container">
                <div class="banner-content text-center">
                    <span>Welcome to our foodbuzz</span>
                    <h2>It's The Food You Love</h2>
                    <!-- <h3 style="color:white">best for restaurant wordpress theme</h3> -->
                ...
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-lg-6 col-12">
                        <div class="about-thumb">
                            <img src="assets/img/burg.jpg" alt="about-food">
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6 col-12">
                            <div class="product-item">
                                <div class="product-thumb">
                                    <img src="assets/img/duck.png" alt="food-product">
                                    <span class="price">80K</span>
                                </div>
                                <div class="product-content">
                                    <p>Bites</p>
                                    <h6><a href="#">Pan-seared Smoked Duck Breast</a></h6>
                                    <div class="rating">
                        ...
                        <div class="col-xl-3 col-md-6 col-12">
                            <div class="product-item">
                                ...
                                <div class="product-content">
                                    <p>Steak</p>
                                    <h6><a>Grilled Yellow Fin Tuna Steak</a></h6>
                                    <div class="rating">
                                        <i class="icofont-star"></i>
                                        <i class="icofont-star"></i>
                                        <i class="icofont-star"></i>
                        ...
                        <div class="col-xl-3 col-md-6 col-12">
                            <div class="product-item">
                                ...
                                <div class="product-content">
                                    <p>Pasta & Rice</p>
                                    <h6><a>Black Squid Ink Fried Rice</a></h6>
                                    <div class="rating">
                                        <i class="icofont-star"></i>
                                        <i class="icofont-star"></i>
                                        <i class="icofont-star"></i>
        ...
        <!-- clients area start -->
        <section class="clients-area padding-tb bg_size p-rel" style="background-image: url(assets/img/meal.jpg);">
            <div class="overlay"></div>
            <div class="container">
                ...
                <div class="footer-bg">
                    <div class="container">
                        <div class="header-item">
                            <div class="header-logo">
                                <p>&copy; 2020<a href="index.html">FoodBuzz</a>Designed by<a href="#">(Nama Lengkap)</a></p>
                            </div>
